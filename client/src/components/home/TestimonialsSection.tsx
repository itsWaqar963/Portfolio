...
const testimonials = [
  ...
  {
    quote: "We hired Waqar to integrate AI capabilities into our existing platform. His work exceeded our expectations—the intelligent search feature he built has significantly improved user engagement.",
    name: "Sarah Johnson",
